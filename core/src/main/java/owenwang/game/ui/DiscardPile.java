...
public class DiscardPile extends Group {
    ...
    protected void sizeChanged() {
        super.sizeChanged();
        number.setPosition(-getWidth() * 0.2f - number.getWidth(), getHeight() * 0.15f);
    }
    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        final var t = Assets.manager.get(Assets.discardPile, Texture.class);
