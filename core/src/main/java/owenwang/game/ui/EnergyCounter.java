...
public class EnergyCounter extends Actor  {
    ...
    public EnergyCounter(MainGame g) {
        this.g = g;
        texture = TextureRegion.split(Assets.manager.get(Assets.orb, Texture.class), 32, 32)[5][0];
    }
    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        batch.draw(texture, getX(), getY(), getWidth() / 2, getHeight() / 2, getWidth(), getHeight(), getScaleX(), getScaleY(), getRotation() - stateTime * 90f);
